namespace Editor {
    ...
    // DEPRECATED — avoid; macroblock methods (e.g. placing via macroblocks) are preferred.
    // Known issues: with duplicate blockIds this may not save and occasionally results in crash-on-saves (but not autosaves)
