...
class Dev_NSceneParticleVis_SMgr : RawBufferElem {
	Dev_NSceneParticleVis_SMgr(RawBufferElem@ el) {
		if (el.ElSize != 0x2E0) throw("invalid size for Dev_NSceneParticleVis_SMgr");
		super(el.Ptr, el.ElSize);
	}
	Dev_NSceneParticleVis_SMgr(uint64 ptr) {
		super(ptr, 0x2E0);
	}
