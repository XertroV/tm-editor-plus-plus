...
class DGameCamera : RawBufferElem {
	DGameCamera(RawBufferElem@ el) {
		if (el.ElSize != 0x690) throw("invalid size for DGameCamera");
	...
	uint get_UnkVisEntId2() { return (this.GetUint32(0x50)); }
	uint get_PlayerClassId2() { return (this.GetUint32(0x60)); }
	uint get_CurrentCamClassId() { return (this.GetUint32(0x68)); }
