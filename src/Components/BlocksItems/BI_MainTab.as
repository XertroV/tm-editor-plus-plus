...
class ViewAllBlocksTab : BlockItemListTab {
    ...
    void SetupMainTableColumns(bool offsetScrollbar = false) override {
        ...
        if (BIL_Settings::Col_IsCP) UI::TableSetupColumn("Is CP", UI::TableColumnFlags::WidthFixed, numberColWidth);
...
class ViewAllItemsTab : BlockItemListTab {
    ...
    void SetupMainTableColumns(bool offsetScrollbar = false) override {
        ...
        if (BIL_Settings::Col_Color) UI::TableSetupColumn("Color", UI::TableColumnFlags::WidthFixed, smlNumberColWidth);
        if (BIL_Settings::Col_LM) UI::TableSetupColumn("LM", UI::TableColumnFlags::WidthFixed, smlNumberColWidth);
        if (BIL_Settings::Col_IsCP) UI::TableSetupColumn("Is CP", UI::TableColumnFlags::WidthFixed, stdNumberColWidth);
        if (BIL_Settings::Col_Size) UI::TableSetupColumn("Size", UI::TableColumnFlags::WidthFixed, smlNumberColWidth);
        UI::TableSetupColumn("Tools", UI::TableColumnFlags::WidthFixed, exploreColWidth);
    }
    ...
    void DrawWaypointOrders(CGameCtnChallenge@ map) {
        if (UI::TreeNode("Waypoint Orders")) {
            ...
            if (UI::BeginTable("wp-orders", 2)) {
                UI::TableSetupColumn("Order", UI::TableColumnFlags::WidthFixed, 50.0 * g_scale);
