...
class BlockVariantBrowserTab : Tab {
    ...
    void DrawBlockInfoInfo(CGameCtnBlockInfo@ bi) {
        ...
        auto mmPlacementTag = Dev::GetOffsetNat2(bi, O_BLOCKINFO_MATMODPLACEMENTTAG);
        Dev::SetOffset(bi, O_BLOCKINFO_MATMODPLACEMENTTAG, UX::InputNat2("MatModifierPlacementTag", mmPlacementTag));
