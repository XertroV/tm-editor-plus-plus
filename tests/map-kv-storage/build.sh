...
cp "$repo/src/Editor/MapKV.as" "$repo/src/Editor/MapKVHealth.as" "$repo/src/Editor/MapKV_Types_Dev.as" "$repo/ascall-spikes/AsCall.as" "$repo/ascall-spikes/Hex.as" "$stage/"
